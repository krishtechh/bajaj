...
export default function Categories({ onSelectCategory }: CategoriesProps) {
  ...
  return (
    <section 
      id="categories" 
      className="py-24 sm:py-32 bg-green-900 text-white relative overflow-hidden"
    >
      ...
      {/* <div className="absolute -bottom-16 -left-16 w-80 h-80 bg-green-900 rounded-full blur-[100px] pointer-events-none" /> */}
