...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    // If cache hasn't been set up yet, do it on the fly once
  ...
  useLayoutEffect(() => {
    ...
    if (useWindowScroll) {
      if (globalLenis) {
        ...
        // Fallback local window scroll lenis
    ...
    window.addEventListener('resize', handleResizeOrLoad, { passive: true });
  ...
  return (
    <div className={`scroll-stack-scroller ${className} ${useWindowScroll ? 'use-window-scroll' : ''}`.trim()} ref={scrollerRef}>
